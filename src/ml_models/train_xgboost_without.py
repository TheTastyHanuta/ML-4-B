...
from src.ml_models.preprocessing import train_test_data, CAT_FEATURES
...
def train_xgboost_without_weather(subset: int | str = 'all', target: str = 'delay_minutes'):
    """
    Train an XGBoost model on the Bahn sub-trip data without weather conditions.
    ...
    metrics_path = base_dir / f'../../models/metrics/xgboost_metrics_without_{target}.csv'
    ...
    if target == 'canceled':
        # For binary classification, evaluate accuracy
...
if __name__ == "__main__":
    print("Starting XGBoost model training without weather data...")
