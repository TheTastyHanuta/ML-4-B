...
# Feature Engineering
features = ['station', 'destination_station', 'day_of_week', 'hour_of_day', 'train_name']
...
# save the model
with open('../../models/lightgbm_model_without.pkl', 'wb') as f:
    pickle.dump(model, f)
...
metrics_df.to_csv('../../models/lightgbm_metrics_without.csv', index=False)
