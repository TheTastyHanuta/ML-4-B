...
df_list = [pd.read_parquet(fp)[["delay_in_min", "train_name", "train_type", "is_canceled"]] for fp in files]
...
with (save_dir / "long_distance_train_stats.json").open("w") as f: # type: ignore
    f.write(json_data)